...
var $author$project$Main$receiveAscii = _Platform_incomingPort('receiveAscii', $elm$json$Json$Decode$string);
var $author$project$Main$receiveFileDataUrl = _Platform_incomingPort('receiveFileDataUrl', $elm$json$Json$Decode$string);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'FileSelected':
				var fileId = msg.a;
				var sendToApi = $author$project$Main$sendFile(fileId);
				var getUrlData = $author$project$Main$requestFileRead(fileId);
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[getUrlData, sendToApi])));
			case 'ReceiveFileDataUrl':
				var dataUrl = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
